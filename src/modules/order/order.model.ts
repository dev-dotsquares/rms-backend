...
export type OrderStatus = 'pending' | 'in_progress' | 'ready' | 'served' | 'paid';
...
interface OrderCreationAttributes extends Optional<OrderAttributes, 'id' | 'table_id' | 'customer_name' | 'customer_phone' | 'notes' | 'created_at' | 'updated_at'> {}
...
Order.init(
  {
    ...
    status: { type: DataTypes.ENUM('pending', 'in_progress', 'ready', 'served', 'paid'), allowNull: false },
