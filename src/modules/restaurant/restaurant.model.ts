...
interface RestaurantCreationAttributes extends Optional<RestaurantAttributes, 'id' | 'created_at' | 'updated_at' | 'revenue'> {}
...
Restaurant.init(
  {
    ...
    status: { type: DataTypes.ENUM('active', 'trial', 'suspended'), allowNull: false },
